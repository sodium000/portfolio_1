...
const AboutSection = () => {
  return (
    <section id="about" className="py-12 md:py-16 px-4 md:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 justify-center">
              <a href="#contact" className="cosmic-button text-sm sm:text-base text-center">
                Get in Touch
              </a>

              <a
                href="Raisul Islam Tonmoy Mern Stack Developer.pdf"
                download
                className="px-5 sm:px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/50 transition-colors duration-300 text-sm sm:text-base text-center"
              >
                Download CV
              </a>
            </div>
