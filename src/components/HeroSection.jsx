...
const HeroSection = () => {
  return (
    <section
      id="hero"
      className="relative px-4 sm:px-6 md:px-8 flex flex-col items-center justify-center min-h-screen bg-hero-pattern bg-cover bg-center text-center"
    >
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 sm:gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="order-2 md:order-1 opacity-0 animate-fade-in-delay-3">
            <div className="relative group">
              ...
              <div className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-64 md:h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden border-4 border-primary/30 shadow-2xl group-hover:border-primary/50 transition-all duration-300 group-hover:scale-105">
          ...
          <div className="order-1 md:order-2 flex-1 text-center md:text-left space-y-4">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
              ...
              <span className="text-gradient ml-1 md:ml-2 opacity-0 animate-fade-in-delay-2">
                Tonmoy
              </span>
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-4xl mx-auto md:mx-0 px-2 md:px-0 opacity-0 animate-fade-in-delay-4">
              ...
              MongoDB.I create some web sites  with modern
              technologies. Specializing in front-end and back-end development,
